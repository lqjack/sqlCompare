...
public class SlaveDeleteResult extends SlaveExecuteResult{
	/**
	 * 
	 */
	...
	public SlaveDeleteResult(int affected,boolean flag,String errorinfo){
	...
	public void displayResult() {
		...
		System.out.println("slaveDeleteResult info:");
		if(success){
