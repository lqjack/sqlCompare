...
public class TableInfo {
	...
	public TableInfo() {
		...
		this.columns = new Vector<ColumnInfo>();
		this.fragmentations = new Vector<FragmentationInfo>();
	}
	...
	public Vector<String> getColumnNames() {
		...
		for (int i = 0; i < this.columns.size(); i++)
			colNames.add(this.columns.elementAt(i).getColumnName());
		return colNames;
	}
	...
	public void printTableInfo() {
		...
		System.out.println("fragNum=" + this.fragmentationNum + ", fragType="
				+ this.fragmentationType);
