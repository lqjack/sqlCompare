...
public class FragmentationInfo {
	...
	public FragmentationInfo(int fragType, String fragName,
			String fragCondition, int siteNO, int size) {
	...
	public FragmentationInfo(int fragType, String fragName,
			String fragCondition, String siteName, int size) {
		this.fragmentationType = fragType;
		this.fragmentationName = fragName;
		this.conditionString = fragCondition;
	...
	public FragmentationInfo(int fragType, int sitNO, int fragSize,
			String condition, FragmentationCondition express) {
		this.fragmentationType = fragType;
	 ...
	 * @param fraginfo
	 *            String, fragmentation info sentence,such as
	 *            "1: condition siteNumber fragSize"
	 */
	...
	public void setFragSize(int size) {
		this.fragmentationSize = size;
	}
	...
	public void printFragmentation() {
		...
		if (this.conditionExpression.fragmentationType == CONSTANT.FRAG_HORIZONTAL) {
			System.out.print("fragType="
					+ this.conditionExpression.fragmentationType);
			System.out.println(",expressSize="
					+ this.conditionExpression.HorizontalFragmentationCondition
							.size());
			for (int i = 0; i < this.conditionExpression.HorizontalFragmentationCondition
					.size(); i++) {
				SimpleExpression expression = this.conditionExpression.HorizontalFragmentationCondition
						.elementAt(i);
		...
		if (this.conditionExpression.fragmentationType == CONSTANT.FRAG_VERTICAL) {
			...
			System.out.println(",columnSize="
					+ this.conditionExpression.verticalFragmentationCondition
							.size());
